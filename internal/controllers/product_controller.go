...
func (pc *ProductController) CreateProduct(c *gin.Context) {
	...
	product, err := pc.Service.CreateProduct(req.Name, req.Description, req.Price, req.Stock)
	if err != nil {
...
func (pc *ProductController) UpdateProduct(c *gin.Context) {
	...
	product, err := pc.Service.UpdateProduct(id, req.Name, req.Description, req.Price, req.Stock)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
